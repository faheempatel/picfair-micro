...
class PicsControllerTest < ActionController::TestCase
  ...
  test "should create pic" do
    assert_difference('Pic.count') do
      post :create, pic: { created_at: @pic.created_at, description: @pic.description, name: @pic.name, updated_at: @pic.updated_at, url: @pic.url }
    end
  ...
  test "should update pic" do
    patch :update, id: @pic, pic: { created_at: @pic.created_at, description: @pic.description, name: @pic.name, updated_at: @pic.updated_at, url: @pic.url }
    assert_redirected_to pic_path(assigns(:pic))
  end
